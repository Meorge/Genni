...
from PyQt6.QtGui import QAction, QIcon, QCloseEvent, QHideEvent
from PyQt6.QtWidgets import QMainWindow, QSizePolicy, QSplitter, QStackedWidget, QTabBar, QToolBar, QVBoxLayout, QWidget
